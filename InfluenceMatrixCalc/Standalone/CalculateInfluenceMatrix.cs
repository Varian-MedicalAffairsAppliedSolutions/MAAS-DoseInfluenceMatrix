...
namespace CalculateInfluenceMatrix
{
    ...
    public class CalculateInfluenceMatrix
    {
        ...
        static void DisplayLicensePrompt()
        {
            Console.WriteLine("Bound by the terms of the Varian limited use software license agreement, press \"l\" to display the license or any key to continue.");
        ...
        static void DisplayFullLicense()
        {
            string licenseText = @"LIMITED USE SOFTWARE LICENSE AGREEMENT
