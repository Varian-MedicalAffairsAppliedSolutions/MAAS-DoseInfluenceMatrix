...
using PhotonInfluenceMatrixCalc;
...
namespace VMS.TPS
{
    ...
    public class Script
    {
        ...
        Patient m_hPatient;
        Course m_hCourse;
        ExternalPlanSetup m_hPlanSetup;
        ...
        public void Execute(ScriptContext context, System.Windows.Window window)
        {
            ...
            m_hPlanSetup = context.ExternalPlanSetup;
        ...
        public void RunInfMatrixCalc()
        {
            ...
            int iMaxDoseCalcRetry = System.Convert.ToInt32(hConfig.AppSettings.Settings["MaxDoseCalcRetry"].Value);
            float beamletSizeX = System.Convert.ToSingle(hConfig.AppSettings.Settings["BeamletSizeX"].Value);
            float beamletSizeY = System.Convert.ToSingle(hConfig.AppSettings.Settings["BeamletSizeY"].Value);
            int iNumBeamletsToBeCalcAtATime = System.Convert.ToInt32(hConfig.AppSettings.Settings["NumBeamletsToBeCalcAtATime"].Value);
            string szEclipseVolumeDoseCalcModel = hConfig.AppSettings.Settings["EclipseVolumeDoseCalcModel"].Value;
            string szCalculationGridSizeInCM = hConfig.AppSettings.Settings["CalculationGridSizeInCM"].Value;
            ...
            Calculate(m_hPatient, m_hCourse, m_hPlanSetup, dInfCutoffValue, bExportFullInfMatrix, iMaxDoseCalcRetry, beamletSizeX, beamletSizeY,
                iNumBeamletsToBeCalcAtATime, szEclipseVolumeDoseCalcModel, szCalculationGridSizeInCM, szOutputRootFolder, hProgress);
        }
        ...
        public static void Calculate(Patient hPatient, Course hCourse, ExternalPlanSetup hPlan, double dInfCutoffValue, bool bExportFullInfMatrix, int iMaxDoseCalcRetry,
            ...
            string szCalculationGridSizeInCM, string szOutputRootFolder, DisplayProgress hProgress)
        {
            ...
            ExportStructureOutlinesAndMasks(hPlan, planResultsPath);
            ...
            //hPlan.SetCalculationOption(hPlan.GetCalculationModel(CalculationType.PhotonVolumeDose), "FieldNormalizationType", "No field normalization");
            ...
            do
            {
                ...
                if (lstCalcBeams.Count > 0)
                {
                    ...
                    do
                    {
                        try
                        {
                            CalculationResult calcRes = hPlan.CalculateDose();
                        ...
                        for (int i = 0; i < iNumBeamletsToBeCalcAtATime; i++)
                        {
                            ...
                            if (lstCalcBeams.Contains(blb.Id))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        arrFullDoseMatrix[iDosePtIdx, 0] -= arrClosedMLCDoseMatrix[iDosePtIdx, 0];
                                    ...
                                    Helpers.WriteInfMatrixHDF5(bExportFullInfMatrix, arrFullDoseMatrix, doseData, bAddLastEntry, iMaxPointCnt, iBeamletIdx, szHDF5DataFile);
                                }
                            }
                        }
                    }
        ...
        public static void ExportStructureOutlinesAndMasks(ExternalPlanSetup hPlanSetup, string szOutputFolder)
        {
